...
template<typename TDevice = Sigma50Device>
class Sigma50DriverT
{
public:
    Sigma50DriverT() = default;
    explicit Sigma50DriverT(TDevice device) : device_(std::move(device)) {}
...
using Sigma50Driver = Sigma50DriverT<>;
